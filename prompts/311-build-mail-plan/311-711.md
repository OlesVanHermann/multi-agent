> **Projet** : freemium — **Répertoire de dev** : `/home/ubuntu/aiapp/`
>
> **Règle build** : après tout `npx vite build` ou `npm run build` réussi → `cd /home/ubuntu/aiapp && git add -A && git commit -m "build: <description>"` — rollback si casse : `git reset --hard HEAD~1`
>
> **Pas de emoji** dans le code, les commits, les messages. C'est trop AI.
>
> **Logs** : `/var/log/freemium/`
