...
```
1. ./patch/hub-receive.sh                      # Lister les patches
...
```
1. ./patch/hub-cherry-pick.sh hub/patch/<projet>/<desc> [commit...]
...
./patch/hub-release.sh patch      # ou minor, major
...
| `./patch/hub-receive.sh --log` | Voir le push log |
| `./patch/hub-cherry-pick.sh <branch> [hash...]` | Cherry-pick un patch |
...
| Script | Usage |
|--------|-------|
| `python3 framework/chrome-bridge.py <cmd>` | Contrôle Chrome via extension CDP |

### Projet
| Script | Usage |
|--------|-------|
| `./patch/upgrade.sh [--dry-run] [version]` | Mettre à jour un projet |
| `./patch/sync-to-git.sh` | Sync framework → git |
