...
25. **TOUJOURS imposer `report-master.sh` avant chaque fin de tour** aux satellites autres que `NNN-1ZZ`, y compris pour un prompt utilisateur direct ; la réponse au demandeur reste une obligation distincte
