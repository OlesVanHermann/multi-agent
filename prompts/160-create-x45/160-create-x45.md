...
tu es quel agent ? qui son tes slaves ? quel est leur etat ? est-ce que tous les jobs de tes slaves sont terminés ? est-ce que toi tu as terminé ? tout le plan est déjà executé ? si oui, bravo, on arrete là. si non, il faut avancer l'execution. verifie l'etat de tous les agents et si besoin relance ceux qui en ont besoin.
EOF
```
