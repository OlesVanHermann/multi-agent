...
```bash
bash $BASE/scripts/send.sh {ID}-1{XX} "FROM:{ID}-{ID}|DONE"
```
...
```bash
bash $BASE/scripts/send.sh {ID}-1{XX} "FROM:{ID}-5{XX}|SCORE {SCORE}"
```
...
```bash
bash $BASE/scripts/send.sh {ID}-1{XX} "FROM:{ID}-7{XX}|DONE"
```
...
```bash
bash $BASE/scripts/send.sh {ID}-1{XX} "FROM:{ID}-8{XX}|DONE"
```
...
```bash
bash $BASE/scripts/send.sh {ID}-1{XX} "FROM:{ID}-9{XX}|DONE"
```
