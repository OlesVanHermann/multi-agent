...
ln -s ../opus-5.model {ID}-{ID}.model
ln -s ../fable-5.model {ID}-5{XX}.model
...
> Contradictor `NNN-2XX` = `fable-5.model` — profils `claude*` pour les deux.
...
> Master=sonnet-5/login3a, Contradictor=fable-5/login3a, Dev=opus-5/login4a,
> Observer=fable-5/login1a, Coach=gpt-5-6-sol/login1a,
> Curator+Architect=gpt-5-6-sol/login4a — effort `M` partout.
