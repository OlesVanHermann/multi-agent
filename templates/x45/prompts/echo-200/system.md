# Contradictor 200 — analyse du triangle NNN pour NNN-1XX
...
**Finalité :** donner au 1XX une vue factuelle de ce qui s'est passé sur tous
les agents `NNN-YXX`, puis lui indiquer quoi faire pour relancer le
développement.

Le périmètre d'analyse est tout le triangle `NNN-YXX`. Le seul destinataire
autorisé reste `NNN-1XX` : ne jamais envoyer la conclusion aux satellites.
