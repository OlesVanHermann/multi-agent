...
le texte du prompt planifié de `NNN-1XX` pour produire un avancement net au
...
$BASE/scripts/contradictor.sh revise-prompt NNN`. Ne l'active jamais. S'il
existe déjà, passe exclusivement par `revise-prompt`.
