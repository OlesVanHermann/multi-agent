...
MODEL="default"  # ou claude-sonnet-5, etc.
...
*Voir aussi : [`docs/AGENT_X45-METHODOLOGY.md`](AGENT_X45-METHODOLOGY.md) — format x45 | [`docs/BRIDGE.md`](BRIDGE.md) — communication Redis*
