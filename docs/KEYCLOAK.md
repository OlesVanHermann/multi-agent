...
./framework/keycloak_user_create.sh <username> <password>

# Lister les utilisateurs
./framework/keycloak_user_list.sh

# Changer un mot de passe
./framework/keycloak_passwd_modify.sh <username> <new-password>

# Supprimer un utilisateur
./framework/keycloak_user_delete.sh <username>
```
...
**Fix** : relancer `./framework/install_keycloak.sh` (configure les scopes automatiquement).
...
./framework/install_keycloak.sh    # Relancer si nécessaire
```
