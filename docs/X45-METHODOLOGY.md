...
Voir [X45-ARCHITECTURE.md](X45-ARCHITECTURE.md) pour le schéma complet.
...
Voir [X45-TEMPLATE-TRIANGLE.md](X45-TEMPLATE-TRIANGLE.md) pour le pattern.
...
Voir [X45-CONVENTIONS.md](X45-CONVENTIONS.md) pour les détails.
...
| Fichier | Rôle |
|---------|------|
| `docs/X45-METHODOLOGY.md` | Ce fichier (point d'entrée) |
| `docs/X45-ARCHITECTURE.md` | Design système et flux |
| `docs/X45-CONVENTIONS.md` | Numérotation et structure |
| `docs/X45-TEMPLATE-TRIANGLE.md` | Pattern triangle universel |
| `templates/x45/` | Templates pour bootstrap |
