...
git clone git@github.com:OlesVanHermann/multi-agent.git /home/ubuntu/multi-agent
...
# origin git@github.com:OlesVanHermann/multi-agent.git (fetch)
# origin git@github.com:OlesVanHermann/multi-agent.git (push)

# Identité git
git config user.name "OlesVanHermann"
...
# Push GitHub (orphan commit, no history — humain uniquement)
./patch/hub-release.sh
```
