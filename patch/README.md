...
```
Client (mx6,mx23,spark)          Hub (mx9)                    GitHub
─────────────────                ──────────────────────       ──────────────
...
| Fichier | Contenu |
|---------|---------|
| [HOW_TO_PATCH.md](HOW_TO_PATCH.md) | Pipeline complet : étapes, commandes, règles, troubleshooting |
