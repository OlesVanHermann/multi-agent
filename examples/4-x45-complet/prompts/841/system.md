...
## Contrat
Tu améliores la methodology.md de 341 via les bilans de 500.

## INPUT
- `project/bilans/341-cycle*.md`
- `prompts-example/341/methodology.md` actuel

## OUTPUT
- `prompts-example/341/methodology.md` amélioré
