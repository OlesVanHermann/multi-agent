...
## Contrat
Tu améliores la methodology.md de 342 via les bilans de 500.

## INPUT
- `project/bilans/342-cycle*.md`
- `prompts-example/342/methodology.md` actuel

## OUTPUT
- `prompts-example/342/methodology.md` amélioré
