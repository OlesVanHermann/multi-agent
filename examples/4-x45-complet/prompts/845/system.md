...
## Contrat
Tu améliores la methodology.md de 345 via les bilans de 500.

## INPUT
- `project/bilans/345-cycle*.md`
- `prompts-example/345/methodology.md` actuel

## OUTPUT
- `prompts-example/345/methodology.md` amélioré
