...
> **Note:** This document describes the legacy v1 infrastructure setup. For the current v2.4
> setup, see [HOW_TO_SETUP.md](../HOW_TO_SETUP.md) and [README.md](../README.md).
