...
info "  python3 $SCRIPT_DIR/../chrome-bridge.py status"
info "  python3 $SCRIPT_DIR/../chrome-bridge.py tab https://www.google.com"
info "  python3 $SCRIPT_DIR/../chrome-bridge.py screenshot test.png"
echo ""
ok "Done!"
