...
def get_my_agent_id():
    ...
    try:
        ...
        # Support MA_PREFIX-based naming: "ma-agent-300" -> "300"
        # This is the standard format when MA_PREFIX is set (default "ma")
        if session_name.startswith("ma-agent-"):
            return session_name.split("ma-agent-")[1]

        # Support legacy naming without prefix: "agent-300" -> "300"
