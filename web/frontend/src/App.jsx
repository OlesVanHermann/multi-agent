            ...
            <div className="color-legend">
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr><td><span className="agent-cell gray border-orange" style={{display:'inline-block',width:40,textAlign:'center'}}>●</span></td><td>Bordure orange</td><td>context_warning — Contexte restant 1-10% (idle ou busy)</td></tr>
                  <tr><td><span className="agent-cell gray border-blue" style={{display:'inline-block',width:40,textAlign:'center'}}>●</span></td><td>Bordure bleue</td><td>selected — Terminal ouvert</td></tr>
