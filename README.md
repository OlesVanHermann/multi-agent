...
### 2. Creer un profil Claude et s'authentifier

```bash
./setup/login_create.sh claude1a
# Claude Code s'ouvre — s'authentifier avec son compte Anthropic
# Puis taper /exit et /exit pour revenir au shell
```

### 3. Lancer l'installation automatique

```bash
claude1a "lis CLAUDE.md setup/HOW_TO_SETUP.md puis go"
```

L'agent lit les instructions et installe tout : Redis, Keycloak, secrets, dashboard.
